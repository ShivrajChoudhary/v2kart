 ...
 *  
 */
package in.com.v2kart.dotzotlspintegration.jalo;
...
import in.com.v2kart.dotzotlspintegration.constants.V2kartdotzotlspintegrationConstants;



/**
 * This is the extension manager of the V2kartdotzotlspintegration extension.
 */
public class V2kartdotzotlspintegrationManager extends GeneratedV2kartdotzotlspintegrationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(V2kartdotzotlspintegrationManager.class.getName());
	...
	{
		return (V2kartdotzotlspintegrationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				V2kartdotzotlspintegrationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public V2kartdotzotlspintegrationManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of V2kartdotzotlspintegrationManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of V2kartdotzotlspintegrationManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of V2kartdotzotlspintegrationManager called, current tenant: " + getTenant().getTenantID());
		}
	}
