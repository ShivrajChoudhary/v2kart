 ...
 *  
 */
package in.com.v2kart.core.suggestion;
...
public interface SimpleSuggestionService {
    ...
    /**
     * @deprecated use getReferencesForPurchasedInCategory(CategoryModel category, List<ProductReferenceTypeEnum> referenceTypes, UserModel
     *             user, boolean excludePurchased, Integer limit) instead.
     */
    @Deprecated
