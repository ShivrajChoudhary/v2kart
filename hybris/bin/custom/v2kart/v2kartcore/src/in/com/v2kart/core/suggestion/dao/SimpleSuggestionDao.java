 ...
 *  
 */
package in.com.v2kart.core.suggestion.dao;
...
/**
 * Dao to retrieve product related data for {@link in.com.v2kart.core.suggestion.SimpleSuggestionService}.
 */
public interface SimpleSuggestionDao extends Dao {
    /**
     * @deprecated use findProductsRelatedToPurchasedProductsByCategory(CategoryModel category, List<ProductReferenceTypeEnum>
