 ...
 *  
 */
package in.com.v2kart.core.externaltax.impl;
...
public class AcceleratorDetermineExternalTaxStrategy implements DecideExternalTaxesStrategy {
    /**
     * Initially just to test if the delivery mode and address are set, than calculate the external taxes. TODO: Hash of products in cart,
     * delivery mode, delivery address and payment information to determine whether or not to calculate taxes.
     */
    @Override
