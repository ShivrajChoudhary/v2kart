...
public class RegistrationEventListener extends AbstractSiteEventListener<RegisterEvent> {
    ...
    protected void onSiteEvent(final RegisterEvent registerEvent) {
        v2SmsService.sendSms(v2UserSmsDataMapPopulator.createV2UserSmsDataMap(registerEvent.getCustomer()),
                "User_registration_message_template",
                registerEvent.getCustomer().getMobileNumber());
