...
/**
 * Checks if any of cart entries is created to be picked up in location. If so, the multi step checkout is always chosen.
 */
public class PickUpInStoreCheckoutFlowStrategy extends AbstractCheckoutFlowStrategy {
    ...
    protected boolean canSupport() {
        ...
        return PickupInStoreMode.BUY_AND_COLLECT.equals(pickupInStoreMode);// ||
                                                                           // PickupInStoreMode.RESERVE_AND_COLLECT.equals(pickupInStoreMode);
    }
