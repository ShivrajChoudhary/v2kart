...
import in.com.v2kart.fulfilmentprocess.events.OrderCancelledEvent;
...
public class OrderCancelledEventListener extends AbstractSiteEventListener<OrderCancelledEvent> {
    ...
    protected void onSiteEvent(final OrderCancelledEvent event) {
        ...
        final OrderModificationProcessModel orderProcessModel = (OrderModificationProcessModel) getBusinessProcessService().createProcess(
