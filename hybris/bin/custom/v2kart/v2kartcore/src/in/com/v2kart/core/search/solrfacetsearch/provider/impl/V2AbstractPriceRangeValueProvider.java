...
public abstract class V2AbstractPriceRangeValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider,
Serializable {
                    ...
                    while (variantProducts.hasNext()) {
                        ...
                        if (!CollectionUtils.isEmpty(currencies)) {
                            for (CurrencyModel currencyModel : currencies) {
                                ...
                                rangeNameList = getRangeNameList(indexedProperty, value, currencyModel.getIsocode());
                                if (null != value) {
                                    Collection<String> fieldNames = this.fieldNameProvider.getFieldNames(indexedProperty, currencyModel.getIsocode()
                                            .toLowerCase());
