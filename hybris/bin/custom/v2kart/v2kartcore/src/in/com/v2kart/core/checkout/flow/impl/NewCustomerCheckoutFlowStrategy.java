 ...
 *  
 */
package in.com.v2kart.core.checkout.flow.impl;
...
/**
 * Prepared for customization flow strategy. Uses a {@link #isNewCustomer()} result to decide if use between {@link #getDefaultStrategy()}
 * and {@link #newCustomerStrategy} configured flow strategy.
 */
public class NewCustomerCheckoutFlowStrategy extends AbstractCheckoutFlowStrategy {
    ...
    /**
     * Method which checks whether customer is new. In this case it just checks if the customer has a default shipping address.
     * 
