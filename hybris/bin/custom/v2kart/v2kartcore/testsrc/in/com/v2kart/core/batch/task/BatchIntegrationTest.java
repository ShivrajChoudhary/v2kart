 ...
 *  
 */
package in.com.v2kart.core.batch.task;
...
public class BatchIntegrationTest extends ServicelayerTest {
    ...
    public void setUp() throws Exception {
        ...
        importCsv("/v2kartcore/test/testBatch.impex", "utf-8");
    ...
    public void testVariant() throws Exception {
        ...
        final V2kartSizeVariantProductModel variant = (V2kartSizeVariantProductModel) productService
                .getProductForCode(variantId.toString());
        Assert.assertEquals("V2kartSizeVariantProduct", product.getVariantType().getCode());
    ...
    protected void createFile(final File file, final Long productId, final FileContent fileContent) throws IOException {
        ...
        try {
            writer = new PrintWriter(new BufferedWriter(new OutputStreamWriter(new FileOutputStream(file), CSVConstants.DEFAULT_ENCODING)));
