...
import in.com.v2kart.dataimport.importengine.excel.impl.ExcelDozerBeanReaderImpl;
...
/**
 * Concrete implementation of ExcelReader extending AbstractFileReader. It reads excel file and convert row items to Java Object using Dozer
 * library.
 * 
 * @author gaurav2007
 */
public class ExcelDozerReaderImpl extends AbstractFileReader implements ExcelReader {
     ...
     */
    private IExcelDozerBeanReader beanReader;
    ...
    public final void open() throws FileReaderException {
        if (beanReader == null) {
            ...
            try {
                beanReader = new ExcelDozerBeanReaderImpl(getFileToProcess(), excelSheetName, noOfColumns, beanMapper);
     ...
     */
    public final IExcelDozerBeanReader getBeanReader() {
        return beanReader;
    }
