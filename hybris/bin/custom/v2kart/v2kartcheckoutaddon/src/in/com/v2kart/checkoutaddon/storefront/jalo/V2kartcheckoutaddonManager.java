 ...
 *  
 */
package in.com.v2kart.checkoutaddon.storefront.jalo;
...
import in.com.v2kart.checkoutaddon.storefront.constants.V2kartcheckoutaddonConstants;



/**
 * This is the extension manager of the V2kartcheckoutaddon extension.
 */
public class V2kartcheckoutaddonManager extends GeneratedV2kartcheckoutaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(V2kartcheckoutaddonManager.class.getName());
	 ...
	 */
	public static V2kartcheckoutaddonManager getInstance()
	{
		return (V2kartcheckoutaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				V2kartcheckoutaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public V2kartcheckoutaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of V2kartcheckoutaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of V2kartcheckoutaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of V2kartcheckoutaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
