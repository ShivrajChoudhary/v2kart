 ...
 *  
 */
package in.com.v2kart.checkoutaddon.storefront.hmc;
...
/**
 * Provides necessary meta information about the v2kartcheckoutaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.4.0.0
 */
public class V2kartcheckoutaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(V2kartcheckoutaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "in.com.v2kart.checkoutaddon.storefront.hmc.locales";
