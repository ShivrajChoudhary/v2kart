...
<table>
        <tr class="header">
            <td><img src="${siteResourcePath}/images/logo.png" id="logo"/></td>
            <td style="text-align: right; padding-right: 20px;" id="safe"><img src="${siteResourcePath}/images/safe.jpg"
    ...
    <form name="waitPageForm" action="${url}" method='post'>
