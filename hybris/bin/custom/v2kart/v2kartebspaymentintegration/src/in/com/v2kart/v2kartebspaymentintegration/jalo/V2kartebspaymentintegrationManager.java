 ...
 *  
 */
package in.com.v2kart.v2kartebspaymentintegration.jalo;
...
import in.com.v2kart.v2kartebspaymentintegration.constants.V2kartebspaymentintegrationConstants;



/**
 * This is the extension manager of the V2kartebspaymentintegration extension.
 */
public class V2kartebspaymentintegrationManager extends GeneratedV2kartebspaymentintegrationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(V2kartebspaymentintegrationManager.class.getName());
	 ...
	 */
	public static V2kartebspaymentintegrationManager getInstance()
	{
		return (V2kartebspaymentintegrationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				V2kartebspaymentintegrationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public V2kartebspaymentintegrationManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of V2kartebspaymentintegrationManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of V2kartebspaymentintegrationManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of V2kartebspaymentintegrationManager called, current tenant: " + getTenant().getTenantID());
		}
	}
