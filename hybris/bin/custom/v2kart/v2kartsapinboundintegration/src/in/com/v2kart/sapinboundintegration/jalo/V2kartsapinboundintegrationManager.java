 ...
 *  
 */
package in.com.v2kart.sapinboundintegration.jalo;
...
/**
 * This is the extension manager of the V2kartsapinboundintegration extension.
 */
public class V2kartsapinboundintegrationManager extends GeneratedV2kartsapinboundintegrationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(V2kartsapinboundintegrationManager.class.getName());
	 ...
	 */
	public static V2kartsapinboundintegrationManager getInstance()
	{
		return (V2kartsapinboundintegrationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				V2kartsapinboundintegrationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public V2kartsapinboundintegrationManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of V2kartsapinboundintegrationManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of V2kartsapinboundintegrationManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of V2kartsapinboundintegrationManager called, current tenant: " + getTenant().getTenantID());
		}
	}
