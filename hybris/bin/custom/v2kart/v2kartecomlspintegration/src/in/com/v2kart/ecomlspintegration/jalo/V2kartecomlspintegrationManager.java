 ...
 *  
 */
package in.com.v2kart.ecomlspintegration.jalo;
...
import in.com.v2kart.ecomlspintegration.constants.V2kartecomlspintegrationConstants;



/**
 * This is the extension manager of the V2kartecomlspintegration extension.
 */
public class V2kartecomlspintegrationManager extends GeneratedV2kartecomlspintegrationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(V2kartecomlspintegrationManager.class.getName());
	 ...
	 */
	public static V2kartecomlspintegrationManager getInstance()
	{
		return (V2kartecomlspintegrationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				V2kartecomlspintegrationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public V2kartecomlspintegrationManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of V2kartecomlspintegrationManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of V2kartecomlspintegrationManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of V2kartecomlspintegrationManager called, current tenant: " + getTenant().getTenantID());
		}
	}
