 ...
 *  
 */
package in.com.v2kart.storefront.web.theme;
...
public class StorefrontResourceBundleSource implements ThemeSource, ResourceLoaderAware, MessageSource {
    ...
    public Theme getTheme(final String themeName) {
        ...
        synchronized (this.themeCache) {
            ...
            final MessageSource addOnBaseMessageSrouce = createAddOnMessageSource(addOnNames, getParentMessageSource(), getBasePrefix());
            ...
            final MessageSource addOnSiteMessageSource = createAddOnMessageSource(addOnNames, siteMessageSource, getSitePrefix(), sitePart);
            ...
            if (LOG.isDebugEnabled()) {
                LOG.debug("Theme created: name '" + themeName + "', iteBasename [" + siteBasename + "], themeBasename [" + themeBasename
                        + "]");
            }
            return theme;
        }
