...
/**
 * Interceptor to create BTG events for visited content pages. Using a filter is not appropriate since pages are retrieved by controllers
 * and populated in the model.
 */
