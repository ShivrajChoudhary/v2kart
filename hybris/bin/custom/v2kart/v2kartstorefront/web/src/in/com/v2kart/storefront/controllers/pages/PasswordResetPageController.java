...
import in.com.v2kart.storefront.forms.validation.V2UpdatePasswordValidator;
...
public class PasswordResetPageController extends AbstractPageController {
    ...
    @Resource(name = "v2UpdatePasswordValidator")
    private V2UpdatePasswordValidator v2UpdatePasswordValidator;
    ...
    public String getExternalPasswordRequest(final Model model) throws CMSItemNotFoundException {
        ...
        // set page title for recovery page
        if (CollectionUtils.isNotEmpty(resourceBreadcrumbBuilder.getBreadcrumbs("forgottenPwd.title"))) {
            model.addAttribute(
                    CMS_PAGE_TITLE,
                    getPageTitleResolver().resolveContentPageTitle(
                            resourceBreadcrumbBuilder.getBreadcrumbs("forgottenPwd.title").get(0).getName()));
        }
    ...
    public String changePassword(@Valid final UpdatePwdForm form, final BindingResult bindingResult, final Model model,
        ...
        v2UpdatePasswordValidator.validate(form, bindingResult);
    ...
    public void setV2UpdatePasswordValidator(V2UpdatePasswordValidator v2UpdatePasswordValidator) {
        this.v2UpdatePasswordValidator = v2UpdatePasswordValidator;
    }
}
