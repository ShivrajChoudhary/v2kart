 ...
 *  
 */
package in.com.v2kart.storefront.interceptors.beforecontroller;

import de.hybris.platform.acceleratorcms.services.CMSPageContextService;
import de.hybris.platform.servicelayer.user.UserService;
import in.com.v2kart.storefront.interceptors.BeforeControllerHandler;
        ...
        if (authentication != null) {
            ...
            if (principal instanceof String) {
                ...
                if (!springSecurityUserId.equals(hybrisUserId)) {
                    LOG.error("User miss-match springSecurityUserId [" + springSecurityUserId + "] hybris session user [" + hybrisUserId
