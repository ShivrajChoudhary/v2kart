 ...
 *  
 */
package in.com.v2kart.storefront.filters;
...
/**
 * Filter which allows us to bypass all of the spring filters for requests to a given path. This is a simple servlet filter. It is intended
 * to be used to serve static resources from the web application. I can be used early in the filter chain to bypass any spring setup or
 * hybris session setup for the static resources.
 */
public class StaticResourceFilter implements Filter {
    ...
    /**
     * Reads the defined http header parameters from the properties into the map and writes to <code>httpResponse</code>. And also register
     * a config change listener to get the properties changes during runtime.
     * 
