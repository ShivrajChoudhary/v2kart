 ...
 *  
 */
package in.com.v2kart.storefront.controllers.cms;
...
import in.com.v2kart.facades.suggestion.SimpleSuggestionFacade;
...
public class PurchasedCategorySuggestionComponentController extends
    ...
    @Override
    protected void fillModel(final HttpServletRequest request, final Model model, final PurchasedCategorySuggestionComponentModel component) {
        final List<ProductData> productSuggestions = simpleSuggestionFacade.getReferencesForPurchasedInCategory(component.getCategory()
                .getCode(), component.getProductReferenceTypes(), component.isFilterPurchased(), component.getMaximumNumberProducts());
