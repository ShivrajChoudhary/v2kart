 ...
 *  
 */
package in.com.v2kart.storefront.util;
...
/**
 * A <code>RequestDataValueProcessor</code> that pushes a hidden field with a CSRF token into forms. This process implements the
 * {@link #getExtraHiddenFields(HttpServletRequest)} method to push the CSRF token obtained from {@link CSRFTokenManager}. To register this
 * processor to automatically process all Spring based forms register it as a Spring bean named 'requestDataValueProcessor' as shown below:
 * 
 * <pre>
