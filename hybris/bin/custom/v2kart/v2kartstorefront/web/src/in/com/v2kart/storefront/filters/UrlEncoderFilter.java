...
import in.com.v2kart.storefront.web.wrappers.UrlEncodeHttpRequestWrapper;
...
/**
 * This filter inspects the url and inject the url attributes if any for that CMSSite. Calls facades to fetch the list of attributes and
 * encode them in the URL.
 */
public class UrlEncoderFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(final HttpServletRequest request, final HttpServletResponse response, final FilterChain filterChain)
        ...
        if (currentUrlEncoderDatas != null && !currentUrlEncoderDatas.isEmpty()) {
            ...
            if (LOG.isDebugEnabled()) {
                LOG.debug("ContextPath=[" + wrappedRequest.getContextPath() + "]" + " Servlet Path= [" + wrappedRequest.getServletPath()
