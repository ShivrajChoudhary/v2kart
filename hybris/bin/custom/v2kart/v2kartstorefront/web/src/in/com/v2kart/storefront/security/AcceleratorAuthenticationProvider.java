...
public class AcceleratorAuthenticationProvider extends CoreAuthenticationProvider {
    ...
    /**
     * check if the user of the cart matches the current user and if the user is not anonymous. If otherwise, remove delete the session cart
     * as it might be stolen / from another user
     * 
     * @param username
