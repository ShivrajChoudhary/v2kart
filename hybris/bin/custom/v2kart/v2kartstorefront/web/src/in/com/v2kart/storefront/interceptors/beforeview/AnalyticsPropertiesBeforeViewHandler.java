...
public class AnalyticsPropertiesBeforeViewHandler implements BeforeViewHandler {
    ...
    protected void addHostProperty(final String serverName, final ModelAndView modelAndView, final String configKey, final String modelKey) {
        /*
         * Changes made to cache the jirafe properties files in a HashMap. The first time the pages are accessed the values are read from
         * the properties file & written on to a cache and the next time onwards it is accessed from the cache.
         */
