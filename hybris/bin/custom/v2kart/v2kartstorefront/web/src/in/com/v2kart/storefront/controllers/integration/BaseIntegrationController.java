 ...
 *  
 */
package in.com.v2kart.storefront.controllers.integration;
    ...
    protected void initializeSiteFromRequest(final HttpServletRequest httpRequest) {
        ...
        try {
            ...
            if (LOG.isDebugEnabled()) {
                LOG.debug("Cannot find CMSSite associated with current URL ( " + absoluteURL + " - check whether this is correct URL) !");
            }
