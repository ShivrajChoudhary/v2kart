 ...
 *  
 */
package in.com.v2kart.storefront.security.cookie;
...
/**
 * Stripped out org.apache.tomcat.util.http.ServerCookie for use of #appendCookieValue(StringBuffer, int, String, String, String, String,
...
public class ServerCookie implements Serializable {
    ...
    public static void appendCookieValue(final StringBuffer headerBuf, final int version, final String name, final String value,
            final String path, final String domain, final String comment, final int maxAge, final boolean isSecure, final boolean isHttpOnly) {
        ...
        /*
         * The spec allows some latitude on when to send the version attribute with a Set-Cookie header. To be nice to clients, we'll make
         * sure the version attribute is first. That means checking the various things that can cause us to switch to a v1 cookie first.
         * 
    ...
    public static final class CookieSupport {
        ...
        /**
         * If true, separators that are not explicitly dis-allowed by the v0 cookie spec but are disallowed by the HTTP spec will be allowed
         * in v0 cookie names and values. These characters are: \"()/:<=>?@[\\]{} Note that the inclusion of / depends on the value of
         * {@link #FWD_SLASH_IS_SEPARATOR}.
         */
        public static final boolean ALLOW_HTTP_SEPARATORS_IN_V0;

        /**
         * If set to false, we don't use the IE6/7 Max-Age/Expires work around. Default is usually true. If STRICT_SERVLET_COMPLIANCE==true
         * then default is false. Explicitly setting always takes priority.
         */
        ...
        /**
         * The list of separators that apply to version 0 cookies. To quote the spec, these are comma, semi-colon and white-space. The HTTP
         * spec definition of linear white space is [CRLF] 1*( SP | HT )
         */
        ...
        static {
            ...
            ALLOW_HTTP_SEPARATORS_IN_V0 = Boolean.valueOf(
                    System.getProperty("org.apache.tomcat.util.http.ServerCookie.ALLOW_HTTP_SEPARATORS_IN_V0", "false")).booleanValue();
            ...
            /*
             * Excluding the '/' char by default violates the RFC, but it looks like a lot of people put '/' in unquoted values: '/': ; //47
             * '\t':9 ' ':32 '\"':34 '(':40 ')':41 ',':44 ':':58 ';':59 '<':60 '=':61 '>':62 '?':63 '@':64 '[':91 '\\':92 ']':93 '{':123
             * '}':125
             */
