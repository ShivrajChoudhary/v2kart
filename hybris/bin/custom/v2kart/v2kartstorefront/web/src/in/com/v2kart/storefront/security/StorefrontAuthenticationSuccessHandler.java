 ...
 *  
 */
package in.com.v2kart.storefront.security;
...
/**
 * Success handler initializing user settings, restoring or merging the cart and ensuring the cart is handled correctly. Cart restoration is
 * stored in the session since the request coming in is that to j_spring_security_check and will be redirected
 */
public class StorefrontAuthenticationSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
    ...
    /*
     * @see org.springframework.security.web.authentication.AbstractAuthenticationTargetUrlRequestHandler# isAlwaysUseDefaultTargetUrl()
     */
    @Override
    ...
    protected String determineTargetUrl(final HttpServletRequest request, final HttpServletResponse response) {
        ...
        /*
         * If the cart has been merged and the user logging in through checkout, redirect to the cart page to display the new cart
         */
    ...
    /**
     * Determine the most recent saved cart of a user for the site that is not the current session cart. The current session cart is already
     * owned by the user and for the merging functionality to work correctly the most recently saved cart must be determined.
     * getCartsForCurrentUser() returns an ordered by modified time list of the saved carts of the user.
     * 
     * @param currentCart
    ...
    @Required
    public void setForceDefaultTargetForUiExperienceLevel(final Map<UiExperienceLevel, Boolean> forceDefaultTargetForUiExperienceLevel) {
