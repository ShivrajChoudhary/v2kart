...
/**
 * Filter that initializes the session for the v2kartstorefront. This is a spring configured filter that is executed by the
 * PlatformFilterChain.
 */
public class StorefrontFilter extends OncePerRequestFilter {
    ...
    protected void fixSecureHttpJSessionIdCookie(final HttpServletRequest httpServletRequest, final HttpServletResponse httpServletResponse) {
