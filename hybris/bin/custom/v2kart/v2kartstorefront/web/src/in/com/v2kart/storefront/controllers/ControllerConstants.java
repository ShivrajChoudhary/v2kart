 ...
 *
 */
package in.com.v2kart.storefront.controllers;
    ...
    interface Views {
        ...
        interface Pages {
            interface Account {
                ...
                String AccountBeASellerPage = "pages/account/accountBeASellerPage";
                String AccountOrderCancellationPage="pages/account/accountOrderCancellationPopup";
                String AccountOrderReturnPage="pages/account/accountOrderReturnPopup";
            }
            ...
            interface Guest {
                ...
                String TrackYourOrderHomePage = "pages/guest/trackYourOrderHomePage";
            }

            interface Product {
                String WriteReview = "pages/product/writeReview";
                String emailFriend = "pages/product/emailFriend";
                String notifyme = "pages/product/notifyme";
            }
        }
