ACCMOB.pickupinstore = {
	...
	bindPDPPickupInStoreButton: function (button)
	{
		$(document.body).on('click', button, function (e)
		{
		$(".pdpPickUpInStoreButton").attr("href",window.location.href+"/pickupInStorePage?qty="+$('#qty').val());
		});
	},
	...
	bindChangeStoreLinks: function (link)
	{
		link.click(function (e)
		{
			...
			$(".cart-changeStore > a").attr("href","cart/pickupInStorePage");
		});
	},
	...
	bindPickupPopupForm: function (form)
	{
		$(document.body).on('pageshow', form, function ()
		{
			...
			ACCMOB.pickupinstore.bindPickUpInStoreResultsList($("html").find('#pickUpInStoreResultsList'));
	},
	...
	initialize: function ()
	{
		with (ACCMOB.pickupinstore)
		{
			...
			bindPDPPickupInStoreButton('.pdpPickUpInStoreButton');
