ACCMOB.autocomplete = {
	...
	{
		$('<div id="suggestions_container"><ul id="suggestions" data-ajax="false" data-role="listview" data-inset="true" data-theme="a" data-content-theme="a"></ul></div>').insertAfter('#bottomHeader');
	},
