...
ACC.pickupinstore = {
	...
	bindAll: function ()
	{
		...
		{
			bindPickupInStoreSelection();
			bindHomeDeliverySelection();
			bindPickupButtonSelection();
			cartPageCheckoutButtons();
			cartPageCheckoutButtonTop();
...
//Disable/enable checkout button in cart page if dealer select
	bindPickupInStoreSelection: function ()
	{

		$(document).on('click', '.basket-page-shipping-ship', function (event)
				{	
			if($.trim($(".storename").html())==''){
				$('#checkoutButtonTop').attr("disabled","disabled");
					$('#checkoutButtonBottom').attr("disabled","disabled");	 
			}
			});	
	},
	
	bindHomeDeliverySelection: function ()
	{
		$(document).on('click', '.updateToShippingSelection', function (event)
				{	
			$('#checkoutButtonTop').removeAttr("disabled");
			$('#checkoutButtonBottom').removeAttr("disabled");
				});	
	},
	bindPickupButtonSelection: function ()
	{
		$(document).on('click', '.pickUp-button', function (event)
				{	
			$('#checkoutButtonTop').removeAttr("disabled");
			$('#checkoutButtonBottom').removeAttr("disabled");
			});	
	},
//Popup msg on disabled checkout button on cart page	
	cartPageCheckoutButtons : function() {

		$(".cartPageButtons").click(function() {
			var button = $(".cartPageButtons button");
			if(button.is(":disabled")) {
				alert("Please Select Dealer");
			}
		});
	},
	cartPageCheckoutButtonTop : function(){
		$(".headline").click(function() {		
			var button = $(".headline button");
			if(button.is(":disabled")) {
				alert("Please Select Dealer");
			}
		});
...
//
					...
					$("#colorbox  form.searchPOSForm").attr("action", ele.data("actionurl"))
//
