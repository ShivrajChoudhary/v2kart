...
<%-- site specific css --%>
<link type="text/css" rel="stylesheet" media="screen" href="${siteResourcePath}/css/jquery.mobile.structure-1.3.0.min.css"/>
<link type="text/css" rel="stylesheet" media="screen" href="${siteResourcePath}/css/changes.css"/>
