...
<div class="cartPageButtons">
	<a class="btn btn-secondary continue-shop-btn" href="${continueShoppingUrl}">
		<spring:theme text="Continue Shopping" code="cart.page.continue"/>
	</a>
	<button id="checkoutButtonBottom" class="btn btn-red right submitCheckoutForm" type="button" data-checkout-url="${checkoutUrl}">
