	...
	<tbody>
        ...
        <c:if test="${cartData.productDiscounts.value > 0}">
            <tr class="savings">
                ...
                <td><ycommerce:testId code="Order_Totals_Savings"><format:price priceData="${cartData.productDiscounts}"/></ycommerce:testId></td>
            </tr>
        </c:if>
        ...
        <c:if test="${cartData.orderDiscounts.value > 0}">
            <tr class="savings">
                ...
                <td><ycommerce:testId code="Order_Totals_Savings"><format:price priceData="${cartData.orderDiscounts}"/></ycommerce:testId></td>
            </tr>
        </c:if>
