...
<!-- <div class="orderBox address"> -->
	<h3><spring:theme code="text.deliveryAddress" text="Delivery Address"/></h3>
	...
	<c:if test="${hasShippedItems}">	
        <div class="del-info">	
    		<ul>
    			<li>${fn:escapeXml(order.deliveryAddress.firstName)}&nbsp;${fn:escapeXml(order.deliveryAddress.lastName)}</li>
