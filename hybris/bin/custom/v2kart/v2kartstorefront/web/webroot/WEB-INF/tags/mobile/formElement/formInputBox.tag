...
<template:errorSpanField path="${path}">
	<ycommerce:testId code="LoginPage_Item_${idKey}">
		<div data-role="fieldcontain" data-theme="c" data-content-theme="c" class="${fieldcontainCSSClass}">
			...
			<div class="${className}">
				...
				<form:input cssClass="${inputCSS}" id="${idKey}" path="${path}" tabindex="${tabindex}" readOnly="${readOnly}"
			 		autocomplete="${autocomplete}" data-theme="c"  maxlength="${maxLength}"  placeholder = "${placeholder}" disabled="${disabled}" />
				<c:if test="${!inlineError}">
