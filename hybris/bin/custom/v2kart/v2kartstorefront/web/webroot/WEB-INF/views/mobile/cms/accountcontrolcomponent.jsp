...
<div id="accountcontrol">
	<div class="top-nav-bar" data-theme="e" data-role="header">
		<c:if test="${empty hideHeaderLinks}">
			...
			<a href="#" id="top-nav-bar-account" data-role="button" role="button" data-theme="e" data-iconpos="notext" data-icon="user" title="Login and Account">
	...
	<c:if test="${empty hideHeaderLinks}">
		<div id="userSettings" class="top-nav-bar-layer user-settings header-popup menu-container" style="display:none; right:0; left:1px;">
