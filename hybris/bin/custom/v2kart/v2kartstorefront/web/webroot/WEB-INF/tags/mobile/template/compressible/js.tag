...
<script type="text/javascript" src="${siteResourcePath}/js/custom/jquery.mobile.autocomplete.custom.js"></script>
...
<script type="text/javascript" src="${siteResourcePath}/js/custom/accmob.menu.js"></script>
<script type="text/javascript" src="${siteResourcePath}/js/custom/accmob.autocomplete.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/accmob.address.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/accmob.cancelorder.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/accmob.returnorder.js"></script>
<script type="text/javascript" src="${siteResourcePath}/js/custom/accmob.facets.js"></script>
<script type="text/javascript" src="${siteResourcePath}/js/custom/accmob.account.js"></script>
<script type="text/javascript" src="${siteResourcePath}/js/custom/accmob.forgotpassword.js"></script>
<script type="text/javascript" src="${siteResourcePath}/js/custom/accmob.cart.js"></script>
<script type="text/javascript" src="${siteResourcePath}/js/custom/accmob.cartremoveitem.js"></script>
...
<script type="text/javascript" src="${siteResourcePath}/js/custom/accmob.product.js"></script>
...
<script type="text/javascript" src="${siteResourcePath}/js/custom/accmob.carousel.js"></script>
<script type="text/javascript" src="${siteResourcePath}/js/custom/jquery.pstrength.custom-1.2.0.js"></script>
<script type="text/javascript" src="${siteResourcePath}/js/jquery.dotdotdot.min.js"></script>
<script type="text/javascript" src="${siteResourcePath}/js/custom-functions.js"></script>
<script type="text/javascript" src="${siteResourcePath}/js/navigation_bar.js"></script>