...
<%-- CSS added for v2kart --%>
<link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/bootstrap.css" />
<link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/bootstrap-theme.css" />
<link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/buttons.css" />
<link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/forms.css" />
<link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/helper.css" />
<link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/jquery.bxslider.css" />
<link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/miniCart.css" />
<link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/navigation.css" />
<link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/siteSearch.css" />
<%-- <link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/style-custom - Copy.css"/> --%>
<link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/style-custom.css" />
<link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/changes.css" />
<link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/facetNav.css" />

<link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/paginationBar.css" />


<link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/productGrid.css" />
<%-- <link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/productList.css"/> --%>
<link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/colorBox.css" />
<link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/productDetails.css" />


<link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/header.css" />
<link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/slider.css" />
<link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/jquery-ui.css" />
<link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/jquery.productColorizer.css" />
<link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/cloudzoom.css"/>


<%-- Theme CSS files --%>
<link rel="stylesheet" type="text/css" media="all" href="${themeResourcePath}/css/changes.css" />

<link rel="stylesheet" type="text/css" media="all" href="${siteResourcePath}/css/non-responsive.css" />
