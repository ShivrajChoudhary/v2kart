...
<div class="display-details">
	<div class="store-tabs js-pickup-tabs">
		...
		<div class="tabhead" aria-label="<spring:theme code="storeDetails.map.link"/>">
			<span class="glyphicon glyphicon-map-marker"></span>
		</div>
		<div class="tabbody">
			<iframe class="js-map-canvas" width="100%" height="200" frameborder="0" style="border:0" src="#"></iframe>
		</div>
		...
		<div class="action">
			...
			<div class="qty-selector js-qty-selector"> 
				<div class="input-group">
					...
					<input type="text" class="form-control js-qty-selector-input" value="${quantity}" name="hiddenPickupQty">
					<span class="input-group-btn">
						<button class="btn btn-primary js-qty-selector-plus" type="button">+</button>
					</span>
				</div>
			</div>
			<button class="btn btn-primary" type="submit"><spring:theme code="text.addToCart"/></button>
			</form:form> 
		</div>
	</div>
</div>
