...
<div id="minicart_data">
	...
	<a href="${basketUrl}" id="top-nav-bar-cart" class="ui-btn-right" data-role="button" data-theme="e" data-iconpos="left" data-icon="cart" title="<spring:theme code="text.cart"/>">
