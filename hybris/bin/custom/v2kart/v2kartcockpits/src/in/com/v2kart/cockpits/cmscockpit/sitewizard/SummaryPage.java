...
public class SummaryPage extends CmsSiteSummaryPage {
    ...
    protected void createSiteTemplatesRow(final Map<String, Object> information, final Vbox contextInformation,
        ...
        contextInformation.appendChild(createSummaryEntryRow(Labels.getLabel("wizard.summarypage.cmssite.templates"), templatesCombobox));
    }
    ...
    protected void createThemeRow(final Map<String, Object> information, final Vbox contextInformation) {
        ...
        contextInformation.appendChild(createSummaryEntryRow(Localization.getLocalizedString("wizard.summarypage.cmssite.theme.name"),
                themeNameBox));
    }
