 ...
 *  
 */
package in.com.v2kart.cockpits.productcockpit.editor;
...
public class ExternalTaxesSectionRenderer implements SectionRenderer {
            ...
            if (section instanceof CustomEditorSection) {
                ...
                if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration) {
                    ...
                    if (secConfig != null) {
                        ...
                        final Label rowLabel = new Label(Labels.getLabel("v2kartcockpits.product.externalTaxes"));
                        rowLabel.setTooltiptext(Labels.getLabel("v2kartcockpits.product.externalTaxes"));
    ...
    protected Div createExternalTaxesEditor(final ProductModel product) {
        ...
        editorDiv.appendChild(editor.createViewComponent(getTaxCodeForProduct(product), Collections.<String, Object> emptyMap(),
                editorListener));
        return editorDiv;
    }
