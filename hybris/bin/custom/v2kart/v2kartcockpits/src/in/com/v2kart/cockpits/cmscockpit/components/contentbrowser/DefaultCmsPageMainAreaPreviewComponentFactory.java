 ...
 *  
 */
package in.com.v2kart.cockpits.cmscockpit.components.contentbrowser;
...
public class DefaultCmsPageMainAreaPreviewComponentFactory extends CmsPageMainAreaPreviewComponentFactory {
    ...
    @Override
    public AbstractMainAreaBrowserComponent createInstance(final AdvancedBrowserModel model, final AbstractContentBrowser contentBrowser) {
