 ...
 *  
 */
package in.com.v2kart.cockpits.setup;
...
import in.com.v2kart.cockpits.constants.V2kartCockpitsConstants;
 ...
 */
@SystemSetup(extension = V2kartCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup {
    ...
    public void createEssentialData(final SystemSetupContext context) {
        ...
        if (importCustomReports) {
            if (MediaManager.getInstance().getMediaFolderByQualifier(V2kartCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1) {
                MediaManager.getInstance().createMediaFolder(V2kartCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
            ...
            try {
                ...
                if (prefix != null) {
                    importImpexFile(context, "/v2kartcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
                }
