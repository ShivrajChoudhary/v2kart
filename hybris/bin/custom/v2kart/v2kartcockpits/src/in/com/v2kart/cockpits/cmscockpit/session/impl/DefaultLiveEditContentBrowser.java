...
import in.com.v2kart.cockpits.components.liveedit.DefaultLiveEditView;
    ...
    public class DefaultLiveEditCaptionComponent extends CaptionBrowserComponent {
        ...
        private Component createEditor(final TypedObject object, final EditorRowConfiguration rowConfig,
            ...
            if (!matchingEditorDescriptors.isEmpty()) {
                ...
                if (cmsSiteModel != null) {
                    customParameters.put("availableItems", getCmsPreviewService().getEditableCatalogs(cmsSiteModel, catalogVersionModel));
                }
        ...
        protected void renderEditors(final Component parent) {
            ...
            if (previewData != null) {
                ...
                final ObjectValueContainer valueContainer = TypeTools.createValueContainer(previewDataTO, new HashSet<PropertyDescriptor>(
                        props), UISessionUtils.getCurrentSession().getSystemService().getAvailableLanguageIsos());
                ...
                if (liveEditBrowserModel.getActiaveCatalogVersion() != null) {
                    ...
                    if (area instanceof DefaultLiveEditBrowserArea) {
                        ...
                        createRightCaptionButton(Labels.getLabel(liveEditModeEnabled ? "browser.liveEditOn" : "browser.liveEditOff"),
                                (liveEditModeEnabled ? "btnliveeditcontent_quickedit_active" : "btnliveeditcontent_quickedit"), hbox,
