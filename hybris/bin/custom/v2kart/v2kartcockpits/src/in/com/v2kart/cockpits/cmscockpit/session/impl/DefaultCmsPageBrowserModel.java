 ...
 *  
 */
package in.com.v2kart.cockpits.cmscockpit.session.impl;
...
import in.com.v2kart.cockpits.cmscockpit.components.contentbrowser.DefaultCmsPageContentBrowser;
import in.com.v2kart.cockpits.cmscockpit.components.contentbrowser.DefaultCmsPageMainAreaPreviewComponentFactory;
...
public class DefaultCmsPageBrowserModel extends CmsPageBrowserModel {
    ...
    public DefaultCmsPageBrowserModel(CMSAdminSiteService cmsAdminSiteService,
            CmsCockpitService cmsCockpitService, ModelService modelService,
            CMSAdminComponentService cmsAdminComponentService,
            CMSAdminContentSlotService cmsAdminContentSlotService) {
            super(cmsAdminSiteService, cmsCockpitService, modelService,
        ...
        if (event instanceof ItemChangedEvent) {
            ...
            case REMOVED:
                ...
                if (changedEvent.getSource() instanceof SectionTableModel) {
                    ...
                    final DefaultCmsPageContentBrowser content = (DefaultCmsPageContentBrowser) area.getCorrespondingContentBrowser(this);
