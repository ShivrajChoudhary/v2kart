...
/**
 * This is the extension manager of the V2kartstore extension.
 */
public class V2kartstoreManager extends GeneratedV2kartstoreManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	private static final Logger LOG = Logger.getLogger(V2kartstoreManager.class.getName());
	 ...
	 */
	public static V2kartstoreManager getInstance()
	{
		return (V2kartstoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				V2kartstoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public V2kartstoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of V2kartstoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of V2kartstoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of V2kartstoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
