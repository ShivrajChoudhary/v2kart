 ...
 *  
 */
package in.com.v2kart.sapoutboundintegration.jalo;
...
import in.com.v2kart.sapoutboundintegration.constants.V2kartsapoutboundintegrationConstants;



/**
 * This is the extension manager of the V2kartsapoutboundintegration extension.
 */
public class V2kartsapoutboundintegrationManager extends GeneratedV2kartsapoutboundintegrationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(V2kartsapoutboundintegrationManager.class.getName());
	 ...
	 */
	public static V2kartsapoutboundintegrationManager getInstance()
	{
		return (V2kartsapoutboundintegrationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				V2kartsapoutboundintegrationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public V2kartsapoutboundintegrationManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of V2kartsapoutboundintegrationManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of V2kartsapoutboundintegrationManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of V2kartsapoutboundintegrationManager called, current tenant: " + getTenant().getTenantID());
		}
	}
