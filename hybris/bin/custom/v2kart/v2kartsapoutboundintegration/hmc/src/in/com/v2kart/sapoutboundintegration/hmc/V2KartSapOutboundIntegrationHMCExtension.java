...
/**
 * Provides necessary meta information about the v2kartcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class V2KartSapOutboundIntegrationHMCExtension extends HMCExtension {
    /** Edit the local|project.properties to change logging behavior (properties log4j.*). */
    @SuppressWarnings("unused")
    private static final Logger LOG = Logger.getLogger(V2KartSapOutboundIntegrationHMCExtension.class.getName());

    /** Path to the resource bundles. */
    public static final String RESOURCE_PATH = "in.com.v2kart.v2kartsapoutboundintegration.hmc.locales";
