 ...
 *  
 */
package in.com.v2kart.ccavenuepaymentintegration.jalo;
...
import in.com.v2kart.ccavenuepaymentintegration.constants.V2kartccavenuepaymentintegrationConstants;



/**
 * This is the extension manager of the V2kartccavenuepaymentintegration extension.
 */
public class V2kartccavenuepaymentintegrationManager extends GeneratedV2kartccavenuepaymentintegrationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(V2kartccavenuepaymentintegrationManager.class.getName());
	 ...
	 */
	public static V2kartccavenuepaymentintegrationManager getInstance()
	{
		return (V2kartccavenuepaymentintegrationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				V2kartccavenuepaymentintegrationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public V2kartccavenuepaymentintegrationManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of V2kartccavenuepaymentintegrationManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of V2kartccavenuepaymentintegrationManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of V2kartccavenuepaymentintegrationManager called, current tenant: " + getTenant().getTenantID());
		}
	}
