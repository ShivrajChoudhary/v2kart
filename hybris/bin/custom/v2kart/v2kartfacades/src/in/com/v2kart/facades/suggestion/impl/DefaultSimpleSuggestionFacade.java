 ...
 *  
 */
package in.com.v2kart.facades.suggestion.impl;
...
public class DefaultSimpleSuggestionFacade implements SimpleSuggestionFacade {
    ...
    public List<ProductData> getReferencesForPurchasedInCategory(final String categoryCode,
        ...
        final List<ProductModel> suggestions = getSimpleSuggestionService().getReferencesForPurchasedInCategory(category, referenceTypes,
                user, excludePurchased, limit);

        return convertProducts(suggestions);
    }

    @Override
    public List<ProductData> getReferencesForProducts(final Set<String> productCodes, final List<ProductReferenceTypeEnum> referenceTypes,
