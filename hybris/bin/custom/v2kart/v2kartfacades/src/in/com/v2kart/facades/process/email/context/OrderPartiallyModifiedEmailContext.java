...
public class OrderPartiallyModifiedEmailContext extends AbstractEmailContext<OrderModificationProcessModel> {
    ...
    private List<OrderEntryData> returnEntries;
    ...
    public void init(final OrderModificationProcessModel orderProcessModel, final EmailPageModel emailPageModel) {
        ...
        requestId = orderProcessModel.getOrderModificationRecordEntry().getPk().toString();
    ...
    protected void fillModifiedEntries(final OrderModificationProcessModel orderProcessModel) {
        modifiedEntries = new ArrayList<OrderEntryData>();
            ...
            for (final OrderEntryModificationRecordEntryModel modificationEntry : orderProcessModel
                    .getOrderModificationRecordEntry().getOrderEntriesModificationEntries()) {
                ...
                if (modificationEntry instanceof OrderEntryReturnRecordEntryModel) {
                    returnEntries.add(orderEntryData);
                } 
                else
