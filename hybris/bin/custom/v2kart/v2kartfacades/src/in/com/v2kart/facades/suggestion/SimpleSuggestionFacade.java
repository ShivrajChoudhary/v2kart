 ...
 *  
 */
package in.com.v2kart.facades.suggestion;
...
public interface SimpleSuggestionFacade {
    /**
     * @deprecated use getReferencesForPurchasedInCategory(String categoryCode, List<ProductReferenceTypeEnum> referenceTypes, boolean
     *             excludePurchased, Integer limit) instead.
     */
    @Deprecated
