...
public class OrderRefundEmailContext extends AbstractEmailContext<OrderProcessModel> {
    ...
    public void init(final OrderProcessModel orderProcessModel, final EmailPageModel emailPageModel) {
        final OrderModificationProcessModel orderModificationProcessModel = (OrderModificationProcessModel) orderProcessModel;

        super.init(orderProcessModel, emailPageModel);
        orderData = getOrderConverter().convert(orderProcessModel.getOrder());
        orderCode = orderProcessModel.getOrder().getCode();
        orderGuid = orderProcessModel.getOrder().getGuid();
        requestId = orderModificationProcessModel.getOrderModificationRecordEntry().getPk().toString();
