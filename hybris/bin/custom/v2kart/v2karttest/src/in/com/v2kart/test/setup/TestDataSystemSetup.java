 ...
 *  
 */
package in.com.v2kart.test.setup;
...
import in.com.v2kart.test.constants.V2kartTestConstants;
import in.com.v2kart.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = V2kartTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup {
    ...
    public void createProjectData(final SystemSetupContext context) {
        if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA)) {
            ...
            importImpexFile(context, "/v2karttest/import/qa-test-users.impex");

            LOG.info("Creating Reviews...");
            importImpexFile(context, "/v2karttest/import/reviews.impex");
            ...
            importImpexFile(context, "/v2karttest/import/cstickets.impex");
        }
    }
}
